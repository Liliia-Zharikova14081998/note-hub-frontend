...
async function fetchNotes(page = 1, tag = "", search = "", perPage = 12) {
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get("/", {
        params
    });
    return response.data;
}
async function fetchNoteById(id) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].get(`/${id}`);
    return response.data;
}
async function createNote(data) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post("", data);
    return response.data;
}
async function deleteNote(id) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].delete(`/${id}`);
    return response.data;
}
async function register(body) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post(`/auth/register`, body);
    return response.data;
}
async function login(body) {
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post(`/auth/login`, body);
    return response.data;
}
}),
...
function SignInPage() {
    ...
    const handleSubmit = async (formData)=>{
        try {
            ...
            setError(error.response?.data?.message ?? error.message ?? 'Oops... some error');
        }
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__709aa86a._.js.map